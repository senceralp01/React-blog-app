...
// İçerdeki bir object'in içinden bir kayıt silmek için
...
// Kaydın hepsini silmek için
// database.ref()
//     .remove()
//     .then(() => {
//         console.log("Kayıt Tamamen Silindi");
//     }).catch((e) => {
//         console.log("Hata", e);
//     });


// Alternatif kayıt silme yöntemi:
// database.ref("title").set(null);
// database.ref("author/name").set(null);
// database.ref().set(null);

// Kayıt güncellemek için:
// database.ref("author").update({name: "İbrahim"}); // update yerine set kulansaydık author object içerisindeki diğer veriler silinirdi.

// Aşağıdaki güncellemede "author/name:" yerine author: yazsaydık surname bilgisini kaybederdik.
// update işlemi esnasında yeni bir alan da eklenebilmektedir.
database.ref().update({
